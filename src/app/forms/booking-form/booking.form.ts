...
const getBookingForm = () => {
  ...
  return fb.group({
    ...
    numberOfAdults: fb.control('', [Validators.required, Validators.pattern(numericRegex), Validators.min(0)]),
    ...
    numberOfTotalTravelers: fb.control('', [Validators.required, Validators.pattern(numericRegex), Validators.min(1)]),
    numberOfDrivers: fb.control('', Validators.required),
